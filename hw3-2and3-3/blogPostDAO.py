...
class BlogPostDAO:
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        try:
            ...
            r = self.posts.update({'permalink': permalink}, {'$push': {'comments': comment}})
            print r
            return r.matched_count  # Change this to return the number of documents updated by the code for HW 3.3
